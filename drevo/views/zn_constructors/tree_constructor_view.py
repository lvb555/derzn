...
class TreeConstructorView(DispatchMixin, TemplateView):
    """Отображение конструктора древовидного вида (на данный момент конструкторы алгоритмов и документов)"""
    ...
    def get_context_data(self, **kwargs):
        ...
        if type_of_zn == 'algorithm':
            ...
            context['title'] = 'Конструктор документов'
...
def get_tr_for_create_relation_in_tree_constructor(request):
    """Получение допустимых видов связей для создания связи в конструкторе древовидного вида"""
...
def get_tr_for_edit_relation_in_tree_constructor(request):
    """Получение допустимых видов связей для редактирования связи в конструкторе древовидного вида"""
...
@require_http_methods(['GET'])
def get_rel_zn_in_tree_constructor(request):
    """Получение допустимых видов связи и связанных знаний для создания связи в конструкторе древовидного вида"""
...
def create_zn_in_tree_constructor(request):
    """Создание знания в конструкторе древовидного вида (с прикрепленными изображениями и файлом)"""
...
def edit_znanie_in_tree_constructor(request):
    """Редактирование атрибутов знания, прикрепленных изображений и файла в конструкторе древовидного вида"""
...
def save_rel_in_tree_constructor(request):
    """Сохранение новой/измененной связи в конструкторе древовидного вида"""
