    ...
    for expert_1 in experts_agreed_1:
        ...
        for expert_2 in experts_agreed_2:
            ...
            if expert_1['expert__id'] == expert_2['expert__id']:
                ...
                common_experts[answer_1][answer_2]['total'] = total_counts[answer_2]
                common_experts[answer_1][answer_2]['percentage'] = (common_experts[answer_1][answer_2]['count'] / total_counts[answer_2]) * 100 if total_counts[answer_2] > 0 else 0
    table = []
