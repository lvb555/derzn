...
def document_object_processing_view(request, doc_pk):
    ...
    # создание/изменение объекта
        ...
        return HttpResponse(json.dumps({'res': 'ok', 'object': model_to_dict(obj_to_return, exclude=['templates_that_use']), 'select_tree': str(form['connected_to'])}), content_type='application/json')
