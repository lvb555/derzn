...
urlpatterns = [
    ...
    path("znanie/<int:pk>/document/edit", DocumentContentTemplate.as_view(), name="edit_text_template"),
    path("znanie/<int:pk>/document/edit/turple_processing", turple_processing_view),
    path("znanie/<int:pk>/document/edit/document_object_processing", document_object_processing_view),
