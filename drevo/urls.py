...
import drevo.views.comment_send_view
...
urlpatterns = [
    ...
    path("like/<int:pk>", drevo.views.comment_send_view.like, name="like"),
    path("dislike/<int:pk>", drevo.views.comment_send_view.dislike, name="dislike"),
]
