...
urlpatterns = [
    ...
    path('constructor_tree/', ConstructorTreeView.as_view(), name="constructor_tree"),
    ...
    path(
        'rel_for_algorithm/create/',
        get_tr_for_create_relation_in_algorithm,
        name="rel_for_algorithm_create"
    ),
    path("get_rel_zn_in_algorithm/", get_rel_zn_in_algorithm, name="get_rel_zn_in_algorithm"),
    path("quiz_constructor/<int:pk>/", QuizConstructorView.as_view(), name="quiz_constructor"),
    path("algorithm_constructor/<int:pk>/", AlgorithmConstructorView.as_view(), name="algorithm_constructor"),
    path("table_constructor/<int:pk>/", TableConstructorView.as_view(), name="table_constructor"),
    path("save_rel_in_algorithm/", save_rel_in_algorithm, name="save_rel_in_algorithm"),
    path("make_copy_of_algorithm/", make_copy_of_algorithm, name="make_copy_of_algorithm"),
    path("delete_relation_in_algorithm/", delete_relation_in_algorithm, name="delete_relation_in_algorithm"),
    path("rel_for_algorithm/edit/", get_tr_for_edit_relation_in_algorithm,
         name="rel_for_algorithm_edit"),
    path("edit_znanie_in_algorithm/", edit_znanie_in_algorithm,
         name="edit_znanie_in_algorithm"),
    path("create_zn_in_algorithm/", create_zn_in_algorithm,
         name="create_zn_in_algorithm"),
