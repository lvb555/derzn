...
from drevo.views.dimensional_distributions_1_view import dimensional_distributions_1
from drevo.views.dimensional_distributions_2_view import dimensional_distributions_2
...
urlpatterns = [
    ...
    path("dimensional_distributions_1", dimensional_distributions_1, name="dimensional_distributions_1"), 
    path("dimensional_distributions_2", dimensional_distributions_2, name="dimensional_distributions_2"), 
