...
class Message(models.Model):
    ...
    Таблица Сообщения
    """
    sender = models.ForeignKey(User, verbose_name = 'Отправитель', related_name = 'sender_of_message', on_delete = models.DO_NOTHING)
    recipient = models.ForeignKey(User, verbose_name = 'Получатель', related_name = 'recipient_of_message', on_delete = models.DO_NOTHING)
