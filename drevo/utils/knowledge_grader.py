from django.db.models import OuterRef, Subquery, Q, Exists, F
...
class KnowledgeGraderService:
    ...
    def get_proof_table(self):
        ...
        relations = self.knowledge.base.filter(
    ...
    def get_grades(self, proof_base_value) -> dict:
        ...
        common_grade_value = user_knowledge_grade_value if user_knowledge_grade_value else proof_base_value
        common_grade = KnowledgeGradeScale.get_grade_object(common_grade_value, use_cache=True)
