...
if (isNew === 'true') {
    ...
    const isMainZm = document.querySelector('script[data-relation]').getAttribute('data-relation');
    ...
    if (isMainZm === 'test')
        ...
        optionToChange = [...answerSelect.options].find(option => option.value === changedZnanieId);
    if (optionToChange)
