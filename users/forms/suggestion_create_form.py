...
class SuggestionCreateForm(forms.Form):
    ...
    knowledge_type = forms.ChoiceField(choices=tz, label='Тип знания', widget=select_widget)
    relation_type = forms.ChoiceField(choices=tr, label='Отношение к старшему знанию', widget=select_widget)
