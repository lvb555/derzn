...
Для общих правил можно воспользоваться [энциклопедией][1] devman, параграф "как чистить код".
В самой энциклопедии есть много информации и по Django, так что рекомендовано к прочтению.
...
[devman]: https://dvmn.org/encyclopedia/
[accept]:
